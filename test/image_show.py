...
"""
原理是，窗口大小改变时，用PIL去resize图像，显示resize后的
"""
class FirstMainWin(QWidget):
    ...
    def initUI(self):
        ...
        self.pil_image=QImage('resources/images/1533577358_+00900.jpg')
...
if __name__ == '__main__':
    ...
    # app.setWindowIcon(QIcon('resources/images/1533577358_+00900.jpg'))
    main = FirstMainWin()
    main.show()
